...
namespace BreganTwitchBot.TwitchCommands
{
    class TwitchBotGeneralMessages
    {
        ...
        private static void GiftSub(object sender, TwitchLib.Client.Events.OnGiftedSubscriptionArgs e)
        {
            switch (e.GiftedSubscription.MsgParamSubPlan)
            {
                ...
                case SubscriptionPlan.Tier1:
                    ...
                    DatabaseQueries.AddUserPoints(e.GiftedSubscription.DisplayName.ToLower(), 15000);
                    DatabaseQueries.AddUserPoints(e.GiftedSubscription.MsgParamRecipientDisplayName, 3000);
                ...
                case SubscriptionPlan.Tier2:
                    ...
                    DatabaseQueries.AddUserPoints(e.GiftedSubscription.DisplayName.ToLower(), 30000);
                    DatabaseQueries.AddUserPoints(e.GiftedSubscription.MsgParamRecipientDisplayName, 3000);
                    messageLimter.AddMessageCount();
                    break;
                case SubscriptionPlan.Tier3:
                    ...
                    DatabaseQueries.AddUserPoints(e.GiftedSubscription.DisplayName.ToLower(), 45000);
                    DatabaseQueries.AddUserPoints(e.GiftedSubscription.MsgParamRecipientDisplayName, 3000);
                    messageLimter.AddMessageCount();
                    break;
            }
        ...
        private static void Resub(object sender, TwitchLib.Client.Events.OnReSubscriberArgs e)
        {
            switch (e.ReSubscriber.SubscriptionPlan)
            {
                ...
                case SubscriptionPlan.NotSet:
                    ...
                    DatabaseQueries.AddUserPoints(e.ReSubscriber.DisplayName.ToLower(), 10000 + e.ReSubscriber.Months * 2000);
                    messageLimter.AddMessageCount();
                    break;
                case SubscriptionPlan.Tier2:
                    ...
                    DatabaseQueries.AddUserPoints(e.ReSubscriber.DisplayName.ToLower(), 20000 + e.ReSubscriber.Months * 2000);
                    messageLimter.AddMessageCount();
                    break;
                case SubscriptionPlan.Tier3:
                    ...
                    DatabaseQueries.AddUserPoints(e.ReSubscriber.DisplayName.ToLower(), 30000 + e.ReSubscriber.Months * 2000);
                    messageLimter.AddMessageCount();
                    break;
        ...
        private static void NewSub(object sender, TwitchLib.Client.Events.OnNewSubscriberArgs e)
        {
            switch (e.Subscriber.SubscriptionPlan)
            {
                ...
                case SubscriptionPlan.NotSet:
                    ...
                    DatabaseQueries.AddUserPoints(e.Subscriber.DisplayName.ToLower(), 10000);
                    messageLimter.AddMessageCount();
                    break;
                case SubscriptionPlan.Tier2:
                    ...
                    DatabaseQueries.AddUserPoints(e.Subscriber.DisplayName.ToLower(), 20000);
                    messageLimter.AddMessageCount();
                    break;
                case SubscriptionPlan.Tier3:
                    ...
                    DatabaseQueries.AddUserPoints(e.Subscriber.DisplayName.ToLower(), 30000);
                    messageLimter.AddMessageCount();
                    break;
                case SubscriptionPlan.Prime:
        ...
        private static void BotConnectedToChannel(object sender, TwitchLib.Client.Events.OnConnectedArgs e)
        {
            ...
            Console.WriteLine($"[Twitch Connection] {DateTime.Now}: Bot Successfully connected");
        }

      
        private static void BitsDonated(object sender, OnBitsReceivedArgs e)
        {
            Console.WriteLine($"[PubSub] {DateTime.Now}: Just received {e.BitsUsed} bits from {e.Username}. That brings their total to {e.TotalBitsUsed} bits!");
            ...
            DatabaseQueries.AddUserPoints(e.Username.ToLower(), e.BitsUsed * 20);
            messageLimter.AddMessageCount();
        }
